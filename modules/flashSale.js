...
render:function(){
	...
	var sty4={"width":"18.5vw","height":"4vh","color":"#a3a3a3","marginLeft":"4.6vw"}
	var sty5={"display":"flex","height":"4vh","width":"27vw"}
	var h3={"font-size":".4rem","height":"4vh","width":"18vw"}
	var spn={"display":"block","width":"6.4vw","height":"3.2vh","background":"#242424","color":"#fff","textAlign":"center","lineHeight":"3.2vh","borderRadius":".06rem"}
	var sty6={"width":"12vw","height":"4vh","lineHeight":"4vh","marginLeft":"16vw"}
	...
	var p1={"height":"4.8vh","lineHeight":"4.8vh"}
	return(	
		<div style={sty1}>
			<div style={sty2}>
				<div style={sty3}>
				...
				<div style={sty7}>
					<dl style={dl}>
						...
						<dd style={dd}>
							<p style={p1}>单人餐</p>
							<p>
								<span style={{"color":"#ff5a00"}}>￥9.9</span>
								<span style={{"fontSize":".26rem","marginLeft":".8vw","textDecoration": "line-through","color":"#d0d0d0"}}>￥25</span>
							</p>
						</dd>
					</dl>
					<dl style={dl1}>
						...
						<dd style={dd}>
							<p style={p1}>煮酒论剑...</p>
							<p>
								<span style={{"color":"#ff5a00"}}>￥19.9</span>
								<span style={{"fontSize":".26rem","marginLeft":".8vw","textDecoration": "line-through","color":"#d0d0d0"}}>￥60</span>
							</p>
						</dd>
					</dl>
					<dl style={dl1}>
...
ReactDOM.render(<Sale/>,document.getElementById("body"));
module.exports=Sale;